...
# RSMgetMarketOrdersByInterval.py
# Takes depthsdata and returns RSMgetMarketOrdersByInterval.py
# RSMgetMarketOrdersByInterval.py
# ["LowExtreme", "AskVolumeinShares", ""BuyVolumeinShares", "AskVolumeinmBTC", "BuyVolumeinmBTC"]

def RSMgetMarketOrdersByInterval(depthsdata, tickerdata):
  ...
  for i in range(-Multiplier, Multiplier):
    ...
    if (i < 0):
      ...
      SFLastPrice = SLastPrice + (SINTERVAL * (i+1))
